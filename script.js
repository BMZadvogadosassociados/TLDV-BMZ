document.addEventListener('DOMContentLoaded', () => {
    ...
    const closerName = document.getElementById('closer-name');
    ...
    function checkFormValidity() {
        ...
        const closerNameValid = closerName.value.trim() !== '';
    ...
    closerName.addEventListener('input', checkFormValidity);
    ...
    processBtn.addEventListener('click', () => {
        ...
        startProcessing(clientName.value, closerName.value, selectedCaseType.value);
    });
